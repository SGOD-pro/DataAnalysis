...
const groupingOptions = [
  {
    ...
    description: "Group data by department",
  },
  { id: "city", name: "Group by City", description: "Group data by city" },
  {
    id: "age_range",
    name: "Group by Age Range",
    description: "Group by age ranges",
  },
  {
    id: "salary_range",
    name: "Group by Salary Range",
    description: "Group by salary ranges",
  },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Filter and transform data from {filename}
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        <Card className="data-card w-full">
          <CardContent className="flex justify-between items-center">
            <div className="flex items-center">
              ...
              <div className="font-bold text-primary ml-3">
              ...
              <label className="text-sm font-medium flex items-center gap-2">
                ...
                <div className=" leading-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {((filteredData.length / originalRows) * 100).toFixed(1)}%
                    remaining
                  </p>
                </div>
              </label>
              <div className="text-2xl font-bold text-accent ml-3">
            ...
            <div className="flex">
              ...
              <div className="text-2xl font-bold text-secondary-foreground m-3">
                {filters.length}
              </div>
            </div>
          </CardContent>
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          <Card className="data-card">
            <CardHeader>
              ...
              <CardDescription>Group data for analysis</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
              <div>
                ...
                <Select
                  ...
                  onValueChange={setSelectedGrouping}
                >
                  <SelectTrigger>
