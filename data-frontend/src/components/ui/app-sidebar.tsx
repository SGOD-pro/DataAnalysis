...
const navigationItems = [
  { url: "/", title: "Upload", icon: Upload },
  { url: "/summary", title: "Summary", icon: Database },
  { url: "/filter", title: "Filter", icon: Filter },
  { url: "/visualize", title: "Visualize", icon: BarChart3 },
  { url: "/analyze", title: "Analyze", icon: Calculator },
  { url: "/export", title: "Export", icon: Download },
  { url: "/chat", title: "Chat", icon: MessagesSquare },
];
...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <Sidebar collapsible="none" className="w-16 sm:w-20 border-r z-20 bg-sidebar/70" {...props}>
